...
> **R:Porque se muestra el contenido de todos los include de las bibliotecas**
...
> **R:Porque esta linea esta comentada entonces no aparece en el preprocesador**
...
> **R:Muestran el numero de linea y el archivo, provenien de stdio.h**
...
> **R:push reserva bytes en la pila , mov carga el valor,add suma uno**
...
> **R:Porque en programa.o no estan definidos aun, por eso aparece como undefined, y en matematica.o los pone como texto**
...
> **R:Porque son funciones de la biblioteca final del sistema, el cargador dinamico las resuelve a la hora de la ejecucion**
...
> **R:La macrofuncion se remplaza en el preprocesamiento, y una funcion real se mantiene hasta el enlazado. La real tiene verificacion**
...
> **R:Uno de tipo T es de texto, y uno de tipo D es de dato**
...
> **R:  ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ffb5c220000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x76fc0000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7ffb5c050000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7ffb5bf00000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7ffb5b480000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7ffb5a6a0000)**

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:Porque gcc ya lo llama por default**
